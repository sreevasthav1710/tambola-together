...
import { ArrowLeft, Circle, Crown, Dice5, Lock, Palette, RefreshCw, Ticket, UserRound } from "lucide-react";
  ...
  async function handleCreate() {
    ...
    try {
      ...
      const playerGameState = isSnakeLadder
        ...
        : isChess
        ? Chess.createPlayerState(playerId, hostName, 0)
        : {};
